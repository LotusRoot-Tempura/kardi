      ...
      >
        ...
        <div className="flex h-[34px] w-[300px] items-center justify-center gap-2 md:h-auto md:w-[600px]">
          ...
          <Link
            ...
            className="flex h-8 flex-1 items-center justify-center overflow-hidden text-ellipsis text-center font-display text-base uppercase leading-none text-inherit no-underline md:h-[72px] md:text-4xl"
            aria-live="polite"
